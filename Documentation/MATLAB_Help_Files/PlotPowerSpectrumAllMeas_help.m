...
% An all-measurements frequency-domain time trace visualization.
%
%% Description
% |PlotPowerSpectrumAllMeas(data, info)| takes a light-level array |data|
% of the MEAS x TIME format, and creates a plot of the absolute value
% squared of the FFT. Each individual time trace is plotted for specified
% groupings.
%
% |PlotPowerSpectrumAllMeas(data, info, params)| allows the user to specify
...
% <tr><td>ylimits</td><td>[0, 0.01]</td><td>Limits of y-axis.</td></tr>
